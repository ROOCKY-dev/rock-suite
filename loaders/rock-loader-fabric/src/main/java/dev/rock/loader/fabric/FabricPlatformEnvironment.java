...
final class FabricPlatformEnvironment implements PlatformEnvironment {

    private final MinecraftServer server;
    private final RockServer info;

    FabricPlatformEnvironment(MinecraftServer server) {
        this.server = server;
        this.info = new RockServer(UUID.randomUUID(), "fabric-server", server.getServerVersion(), ServerType.FABRIC);
    }
